...
const postVolunteerSignUp = async (req, res, next) => {
  ...
  try {
    ...
    const newVolunteer = { username, email, password, name, lastname, age, genre }
...
const postOrganizerSignUp = async (req, res, next) => {
  ...
  try {
    const newOrganizer = { username, email, contactEmail, password, name, telephone, social, location }
