...
activityRoute.patch("/:activityId/instancias/instanceId", payloadValidator(activityInstancePatchRequestSchema), verifyAccessLevel([USER_ORGANIZER]), postActivityInstance);
