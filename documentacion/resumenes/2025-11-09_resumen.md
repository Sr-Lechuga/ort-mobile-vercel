...
- Expuesto perfil público de voluntarios con badges y actividades asistidas (RF-09).
- Expuesto perfil público de centros con datos de contacto, focos y actividades activas (RF-10).
- Ajustado repositorios y servicios para agregar información derivada (badges, instancias y focos).
...
- Los perfiles públicos retornan solamente información no sensible, generando focos desde actividades activas y ocultando correos privados.
...
- Evaluar cacheo ligero para perfiles públicos y evitar recomputar agregaciones en cada consulta.
